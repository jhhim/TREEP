...
<main>
    ...
    <div class="profile-background">
        <div class="profile-img-container">
            <img src="${path}/resources/img/mypage/${img}" id="profile-img"></img>
        </div>
    </div>
    ...
    <!-- 프로필 설정 -->
    <form method="post" class="profile-setting container-sm" style="max-width: 480px;" enctype="multipart/form-data" action="${path}/profileModify">
        ...
        <div class="profile-setting-photo">
            ...
            <div class="photo-upload input-group ">
                <input type="file" class="form-control" id="profile-upload-img" name="user_img" value="${path }/resources/img/mypage/${img}">
                <label class="input-group-text" for="profile-upload-img">업로드</label>
            </div>
            <div id="preview-container" class="mt-3">
                <img src="${path}/resources/img/mypage/${img}" id="image-preview" src="#" alt="Image Preview" style="max-width: 100%;">
            </div>
            <br>
        ...
        <div class="profile-setting-email">
            ...
            <div class="input-email">
                <input type="text" value="${email }" class="form-control" id="email" readonly name="profileEmail">
            </div>
        </div>
        ...
        <div class="row profile-setting-button">
            ...
            <div class="col">
                <button type="submit" class="btn" id="save">저장</button> <!--  onclick="profileModify()" -->
            </div>
        </div>
    </form>
</main>
