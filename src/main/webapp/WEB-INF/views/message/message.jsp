    ...
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="receive" role="tabpanel" aria-labelledby="receive-tab">
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                           <!-- 보관 버튼 -->
                                            <button type="button" class="btn" id="note-detail-store" data-bs-toggle="modal" data-bs-target="#note-detail-store" onclick="location.href='RevStore?message_no=${msg.message_no}'">보관</button>
                                              <!-- 삭제버튼 -->
            ...
            <span class="note-manage">
                ...
                <button type="button" class="btn" id="note-store"  data-bs-toggle="modal"
                    data-bs-target="#exampleModal">보관</button>  <!-- onclick="storeNote()" -->
