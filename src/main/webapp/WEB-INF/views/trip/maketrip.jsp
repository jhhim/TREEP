...
<script>
	window.addEventListener('beforeunload', function(event) {
		const abc = '개같네';
		return (event.returnValue = abc);
	});
</script>
<jsp:include page="/WEB-INF/views/common/header.jsp"></jsp:include>
<main>
	<form action="${path}/submittrip" method="post" id="submittrip">
		<div class="Plan-Total-container container-fluid w-100"
			style="margin: 0; padding: 0;">
			<div class="row w-100">
				<div class="detail-trip col-md-3" style="padding: 0;">

					<div class="trip-title-input input-group mb-3"
						id="trip-title-input">
					...
					<div class="Plan-Calendar-container">
								...
								<div class="modal-content">
									...
									<div class="modal-footer">
										<button type="button" class="btn btn-secondary"
											data-bs-dismiss="modal" onclick="location.href='${path}'">Close</button>
										<button type="button" class="btn btn-primary"
											data-bs-dismiss="modal" id="calclick"
						...
						<div class="Plan-write-container"></div>


					</div>
					<input id="selected-photo-url" name="place_photo_url"
						style="display: none;" />
					...
					<div class="offcanvas-content">
						...
						<div class="p-3">
							...
							<div class="selected-places-section p-3">
								...
								<div id="place-select-btnContainer">
									<button type="button" class="btn" id="place-select-button"
										data-bs-toggle="modal" data-bs-target="#placeSelectComplete"
										style="display: none;">선택한 장소적용</button>




									<button type="button" class="btn" id="select-place-reset"
										style="display: none;">
			...
			<!-- 선택완료 모달 -->
			<div class="modal fade" id="placeSelectComplete" tabindex="-1"
				...
				<div class="modal-dialog modal-dialog-centered">
					<div class="modal-content">
						...
						<div class="modal-body">선택한 장소들이 적용되었습니다.!</div>
						<div class="modal-footer">
							<button type="button" class="btn" id="selectPlaceCombtn"
