...
//	public ResponseEntity<List<MsgRevDTO>> selectMsgRev (@RequestParam(value="page", defaultValue = "1") int currentPage, HttpSession session) {
//		// session이 누군지에 따라서 보여주기(현재는 임의로 1인애 찾기)\
//		
//		
//		List<MsgRevDTO> revList = new ArrayList<MsgRevDTO>();
//		
...
//		
//		revList = service.selectRev(member_no);
//		
//		
//
//		
//		return ResponseEntity.status(HttpStatus.OK).body(revList);
//	}
//	
//}
