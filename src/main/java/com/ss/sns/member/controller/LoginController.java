...
//		System.out.println("value" + member);
	...
	@RequestMapping("/kakao/share")
	public String kakaoShareGet(HttpSession session) {
	...
	@PostMapping("/kakao/share")
	public String kakaoSharePost(HttpSession session) {
		String token = session.getAttribute("token").toString();
		service.getkakaofirends(token);
		return "redirect:/";
	}
